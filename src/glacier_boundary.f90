...
module glacier_boundary_mod
  ...
  ! specify the boundary conditions for glacier types. Boundaries are
  ...
  type, public :: glacier_boundary
    ...
    ! conditions of glaciers are to be specified. The descendent types
    ! can contain whatever data is needed to compute the result. For
    ! general boundary conditions, it provides the routine 
    ! [[glacier_boundary:get_boundaries_residual]] to return an array
    ! with the residuals representing deviation from satisfying the
    ! conditions. This can then be appended to a [[glacier]]'s residual 
  ...
  contains
    ...
    procedure :: residual_size
      ...
      !! [[glacier_boundary:boundary_residuals]]. 
...
contains
  ...
  function boundary_residuals(this, thickness, velocity, t) &
    ...
    !  Date: September 2016
    !
    ! Default implementation of the [[glacier_boundary:boundary_residuals]]
  ...
  function residual_size(this)
    ...
    !  Date: September 2016
    !
    ! Default implementation of the [[glacier_boundary:residual_size]]
    ! routine providing the size of the residual array returned by
    ! [[glacier_boundary:boundary_residuals]]. For performance
