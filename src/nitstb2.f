c ------------------------------------------------------------------------
c
c This is nittfq2, a copy of the BiCGSTAB routine in the NITSOL
c package. It has been modified so that it will take an initial guess of
c the solution.
c
c ------------------------------------------------------------------------
      subroutine nitstb2 (n, xcur, fcur, step, eta, f, jacv, rpar, ipar,
     $     ijacv, irpre, iksmax, ifdord, nfe, njve, nrpre, nli, r, rtil,
     $     p, phat, v, t, rwork1, rwork2, rsnrm, dinpr, dnorm, itrmks)
...
c Set up r and rtil. 
c ------------------------------------------------------------------------
CC      call dcopy(n,fcur,1,r,1)
CC      temp = -1.d0
CC      call dscal(n,temp,r,1)
c*************************************************************************
c
...
c*************************************************************************
     ...
     $     itask, nfe, njve, nrpre, step, r, rwork1, rwork2, dnorm,
     $     itrmjv )
