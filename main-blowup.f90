...
program isoft
  ...
  discharge = 1e-6_r8
  offset = 0.001
  plume_thickness_lower = 0.00538993456212_r8
  plume_temperature_lower = ambient_salinity
  plume_salinity_lower = ambient_temperature
  plume_velocity_lower = [0.00195863121057_r8, 0._r8]
...
contains
  ...
  pure function h(x)
    ...
    real(r8)                           :: h
    h = ice_thickness_lower - 0.1*x(1)*r_val
  end function h
